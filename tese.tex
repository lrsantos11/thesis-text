...
\documentclass[%
                ...
                chapterprefix, 
                appendixprefix,
				]{scrbook}  % Para menos de 100 paginas.
% \documentclass[12pt, letterpaper, twoside, bibliography=totoc, cleardoublepage, ]{scrbook}  % Para mais de 100 paginas.
...
\newcommand{\titulo}{Escolha Adiada de Parâmetros para Métodos de Pontos Interiores}
...
\newcommand{\coorientador}{Fernando da Rocha Villas-Bôas e Clóvis Perin}
