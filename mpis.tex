...
\end{cases}
\]
Fazendo $Ze=\tau X^{-1}e$, ou equivalentemente $XZ e= \tau e$, obtemos a
...
é uma modificação em alguma variação de um método do tipo  preditor-corretor
 devido a \textcite{Mehrotra:1992wr}. O \acrodef{MPC-M}{Método Preditor Corretor de Mehrotra} \ac{MPC-M} se baseia no modelo geral
