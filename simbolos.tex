...
\begin{description}
    ...
    \item[$m,\, n,\, p,\, q,\, i,\, j,\, \ell$] Variáveis ou constantes  naturais.
...
\item[$I_{n}$] Matriz identidade de ordem $n$.
    ...
    \item[$uv$]  Produto de Hadamard~\cite[p.~455]{Horn:1985tf} entre $u$ e $v$ dado por $uv = \diag(u)v$, isto é, $uv$ é o vetor em $\Real^n$ tal que cada componente  $(uv)_i  = u_iv_i$, para $i=1,\ldots,n$.
